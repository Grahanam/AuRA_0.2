    ...
    <>
      <div className="md:w-48 lg:w-64 h-full flex-none bg-black hidden md:block lg:block">
        <div className="h-10 p-5 pb-10 mb-5 text-center">
          <Link to="/" className="flex flex-row items-center ">
            <i className="p-1 rounded bg-white">
              <img
                className="md:h-5 lg:w-5 md:h-6 lg:w-6"
                src={auralogo}
                alt="logo"
              />
            </i>
            <span className="md:text-3xl lg:text-4xl font-extrabold text-white">
              URA.
            </span>
          </Link>
        </div>
        <div className="mx-2 mt-2 mb-2 rounded bg-neutral-900">
          <Link to="/" className="">
            <button
              className={`w-full md:text-md rounded-none lg:text-lg font-semibold ${
                location === "/" ? "text-white" : "text-gray-400"
              } hover:text-white rounded px-3 py-2 flex items-center justify-start`}
            >
              <i>
                <FontAwesomeIcon
                  icon={faHome}
                  className="mx-2 md:text-xl lg:text-2xl"
                />
              </i>
              <p>Home</p>
            </button>
          ...
          <Link to="/search" className="">
            <button
              className={`w-full md:text-md lg:text-lg font-semibold ${
        ...
        <div className="mx-2  rounded bg-neutral-900">
          ...
          <Link to="/playlist" className="">
            <button
              className={`w-full md:text-md lg:text-lg font-semibold ${
                location === "/playlist" ? "text-white" : "text-gray-400"
              } hover:text-white rounded px-3 py-2 flex items-center justify-start`}
            >
              <i>
                <FontAwesomeIcon
          ...
          <Link to="/jam" className="">
            <button
              className={`w-full md:text-md lg:text-lg font-semibold ${
                location === "/jam" ? "text-white" : "text-gray-400"
              } hover:text-white rounded px-3 py-2 flex items-center justify-start`}
            >
              <i>
                <FontAwesomeIcon
