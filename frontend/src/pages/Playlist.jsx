...
const Playlist = () => {
  ...
  let createplaylist = async () => {
    ...
    try {
      await dispatch(savePlaylist(data)).unwrap(); // Wait for savePlaylist to complete
      dispatch(fetchPlaylist(token?.userid)); // Fetch updated playlists
    } catch (error) {
              ...
              <div className="p-3 md:p-4 lg:p-5 w-[100%]">
                <div className="flex flex-wrap">
                  ...
                  <div className=" lg:ml-2 flex flex-col justify-end md:p-1 lg:p-1">
                    ...
                    <h1 className="text-xl md:text-3xl lg:text-5xl font-extrabold tracking-wide pb-2 md:pb-3 lg:pb-5 text-black">
                      <input
                        type="text"
                        name="title"
        ...
        <>
          <div className="flex flex-col items-center h-full py-2">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-3xl my-4 font-semibold text-white tracking-wide">
              Sign-in to create your playlist
            </h1>
